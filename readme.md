...
(https://github.com/Andrehlb/desenvolve2023.github.io.git)
...
Courses:
JavaScript e HTML: desenvolva um jogo e pratique lógica de programação (from 07/04/2023 to 08/04/2023) 16hrs
JavaScript e HTML: pratique lógica com desenhos, animações e um jogo (from 09/04/2023 to 11/04/2023) 10hrs
HTML5 e CSS3 parte 1: crie uma página da Web (from 12/04/2023 to 14/04/2023) 8hrs
HTML5 e CSS3 parte 2: posicionamento, listas e navegação (from 15/04/2023 to 17/04/2023) 8hrs
HTML5 e CSS3 parte 3: trabalhando com formulários e tabelas (from 18/04/2023 to 20/04/2023) 8hrs
HTML5 e CSS3 parte 4: avançando no CSS (from 21/04/2023 to 23/04/2023) 8hrs
Git e Github: controle e compartilhe seu código (from 24/04/2023 to 26/04/2023) 6hrs

Complementary content:
Hipsters: CSS: Cansei de Ser Simples – Hipsters #09 - 50min
Alura+: Como Front-End utiliza o Figma - 9min
Site: T5- Formação Iniciante em Programação - 0min
Video: Como usar o fórum - Gui Lima - YouTube - 60min
Artigo: 5 dúvidas de quem quer iniciar na carreira de programação | Alura Cursos Online - 30min
Artigo: Saiba tudo sobre o IDE - Integrated Development Environment - 30min
Artigo: Sublime, Atom ou VSCode: qual melhor editor de código? | Alura - 30min
Artigo: VisualStudio Code: instalação, teclas de atalho, plugins e integrações - 30min
Artigo: HTML, CSS e Javascript, quais as diferenças? | Alura Cursos Online - 30min
Artigo: Centralizando um elemento com CSS | Alura Cursos Online - 30min
Artigo: Git e Github: O que são, Como Configurar e Primeiros Passos | Alura Cursos Online - 30min
Artigo: Nova exigência do Git de autenticação por token, o que é e o que devo fazer? | Alura - 30min
Artigo: Iniciando um repositório com Git | Alura - 30min
Site: Trilha Iniciante em programação T5 - 0min
Site: Challenges - ONE | Alura Cursos Online - 0min
Site: Sprint 01: Construa um decodificador de texto com Javascript | Alura Cursos Online - 0min

Data Science Courses:

Degree: SQL com PostgreSQL - 46hs
PostgreSQL (from 15/03/2023 to 17/03/2023) 8hrs
PostgreSQL: Views, Sub-Consultas e Funções (from 18/03/2023 to 19/03/2023) 6hrs
PostgreSQL: comandos DML e DDL (from 20/03/2023 to 22/03/2023) 8hrs
PostgreSQL: desenvolva com PL/pgSQL (from 23/03/2023 to 25/03/2023) 8hrs
PostgreSQL: Triggers, transações, erros e cursores (from 26/04/2023 to 28/04/2023) 8hrs
PostgreSQL: administração e otimização do banco (from 29/03/2023 to 31/03/2023) 8hrs

Degree: Modelagem de dados - 34hs
Courses:
Modelagem de banco de dados: entidades, relacionamentos e atributos (from 01/04/2023 to 03/04/2023) 8hrs
Modelagem de banco de dados relacional: modelagem lógica e física (from 04/04/2023 to 06/04/2023) 8hrs
Modelagem de banco de dados relacional: Álgebra Relacional (from 18/04/2023 to 18/04/2023) 6hrs
Modelagem de banco de dados relacional: normalização (from 07/04/2023 to 09/04/2023) 6hrs
Modelagem de banco de dados relacional: entendendo SQL (from 10/04/2023 to 11/04/2023) 6hrs

Degree: Modelagem de dados - 28hs
Courses:
Modelagem de banco de dados: entidades, relacionamentos e atributos (from 12/04/2023 to 14/04/2023) 8hrs
Modelagem de banco de dados relacional: modelagem lógica e física (from 14/04/2023 to 16/04/2023) 8hrs
Modelagem de banco de dados relacional: normalização (from 17/04/2023 to 17/04/2023) 6hrs
Modelagem de banco de dados relacional: entendendo SQL (from 18/04/2023 to 18/04/2023) 6hrs

Degree: Desenvolvimento Pessoal T5 - ONE - 34hs
Courses:
LinkedIn: como fazer o seu perfil trabalhar para você (from 17/04/2023 to 17/04/2023) 4hrs
Foco: trazendo mais resultados para o dia a dia (from 17/04/2023 to 17/04/2023) 10hrs
Hábitos: da produtividade às metas pessoais (from 05/04/2023 to 16/04/2023) 8hrs
Aprender a aprender: técnicas para seu autodesenvolvimento (from 04/04/2023 to 05/04/2023) 8hrs
Complementary content:
Artigo: Técnica Pomodoro: gerencie seu tempo com simplicidade | Alura Cursos Online - 30min
Artigo: Planejando meus estudos | Alura Cursos Online - 30min
Artigo: Estudar todos os dias, e o que mais? As dicas do Aluno Alura Eduardo Branquinho - 30min
Video: Alura Live #51 - Hábitos: como ser mais produtivo? - YouTube - 60min
Site: Trilha Dsnv. Pessoal T5 - 0min
Video: https://www.youtube.com/watch?v=VljI7NbyVHE - 60min
Artigo: 04 pontos essenciais que o Gui Silveira já nos ensinou para aprender a aprender! - 30min
Courses:
Programação - 57hs
JavaScript e HTML: desenvolva um jogo e pratique lógica de programação (from 23/01/2023 to 16/04/2023) 16hrs
Python: começando com a linguagem (from 30/01/2023 to 05/02/2023) 12hrs
Python: avançando na linguagem (from 30/01/2023 to 17/02/2023) 12hrs
Python Collections parte 1: listas e tuplas (from 17/02/2023 to 16/04/2023) 8hrs
Python Collections parte 2: conjuntos e dicionários (from 16/04/2023 to 16/04/2023) 9hrs
Front-end - 9hs
Flexbox: posicione elementos na tela (from 06/06/2023 to 07/06/2023) 9hrs
DevOps - 48hs
Linux I: conhecendo e utilizando o terminal (from 23/04/2023 to 03/05/2023) 4hrs
Linux II: programas, processos e pacotes (from 09/05/2023 to 15/05/2023) 8hrs
Shell Scripting parte 1: scripts de automação de tarefas (from 16/05/2023 to 28/05/2023) 8hrs
Integração Contínua: mais qualidade e menos risco no desenvolvimento (from 28/05/2023 to 10/06/2023) 6hrs
Microsserviços: padrões de projeto (from 15/05/2023 to 15/05/2023) 6hrs
Microsserviços: explorando os conceitos (from 15/05/2023 to 15/05/2023) 8hrs
Microsserviços na prática: entendendo a tomada de decisões (from 15/05/2023 to 15/05/2023) 8hrs
Data Science - 38hs
Business Intelligence: trabalhando com Data Warehouse (from 23/04/2023 to 23/04/2023) 12hrs
ETL com Integration Services: modelo de dados (from 03/05/2023 to 03/05/2023) 6hrs
OLAP com SQL Server: construção do Data Warehouse (from 15/05/2023 to 15/05/2023) 10hrs
ETL com Integration Services: transformação de dados (from 15/05/2023 to 15/05/2023) 10hrs
